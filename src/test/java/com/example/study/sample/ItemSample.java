...
public class ItemSample extends StudyApplicationTests {
    ...
    public void createHomeAppliance(){
        ...
        for(Partner p : partnerList){
            ...
            for(int i = 1 ; i < 6; i ++){
                ...
                ItemStatus status = getItemStatus(div);
                ...
                Item item = Item.builder()
                        ...
                        .content(p.getName()+"의 가전제품"+i+"호"+"의 가전제품 입니다. 2020년도 신제품 입니다")
                        .brandName(p.getName())
    ...
    private ItemStatus getItemStatus(int num) {
        ItemStatus itemStatus = ItemStatus.UNREGISTERED;

        switch(num) {
            case 0:
                itemStatus = ItemStatus.UNREGISTERED;
                break;
            case 1:
                itemStatus = ItemStatus.REGISTERED;
                break;
            case 2:
